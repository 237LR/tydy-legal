...
- `[YEAR]` - 2026
- `[YOUR ADDRESS]` - Contact via email
- `[YOUR JURISDICTION]` - Poland
- `[YOUR TIMEZONE]` - CET (Central European Time)
- `[YOUR WEBSITE]` - https://tydy.app
- `[YOUR SOCIAL HANDLES]` - Follow @tydy.app

### Email Addresses to Set Up

Make sure these email addresses are created and monitored:

- `karoljaworsky@gmail.com` - All inquiries (legal, privacy, support, premium, DMCA, feedback, bugs, business, press)
